...
from animdl.__version__ import __core__
...
setup(
    ...
    keywords=['stream', 'anime', 'download', 'anime-downloader', 'twist', '9anime', 'gogoanime', 'animepahe', '4anime', 'anime-streamer', 'fouranime', 'animixplay'],
    install_requires=[
        'click',
        'comtypes',
        'lxml',
